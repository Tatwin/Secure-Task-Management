    ...
    `;
      ...
      `
        ...
        function step(dt: number) {
            ...
            gl.uniform2f(gradienSubtractProgram.uniforms.texelSize, velocity.read.texelSizeX, velocity.read.texelSizeY);
            ...
            if (!ext.supportLinearFiltering)
                gl.uniform2f(advectionProgram.uniforms.dyeTexelSize, dye.read.texelSizeX, dye.read.texelSizeY);
